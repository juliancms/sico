...
{    
    ...
    public function cerrarAction($id_periodo){
    	...
    	$db->query("UPDATE cob_actaconteo_persona_facturacion, $tabla_certificar SET cob_actaconteo_persona_facturacion.certificacionFija = 1, cob_actaconteo_persona_facturacion.certificacion = 1, cob_actaconteo_persona_facturacion.asistenciaFinal = 7 WHERE cob_actaconteo_persona_facturacion.id_actaconteo_persona_facturacion = $tabla_certificar.id_actaconteo_persona_facturacion AND cob_actaconteo_persona_facturacion.id_periodo = $id_periodo AND $tabla_certificar.asistencia = 7");
    	$db->query("UPDATE cob_actaconteo_persona_facturacion, $tabla_certificar SET cob_actaconteo_persona_facturacion.certificacionFija = 1, cob_actaconteo_persona_facturacion.certificacion = 1, cob_actaconteo_persona_facturacion.asistenciaFinal = 1 WHERE cob_actaconteo_persona_facturacion.id_actaconteo_persona_facturacion = $tabla_certificar.id_actaconteo_persona_facturacion AND cob_actaconteo_persona_facturacion.id_periodo = $id_periodo AND $tabla_certificar.asistencia = 1");
    	$db->query("UPDATE cob_actaconteo_persona_facturacion SET certificacionFija = 2, certificacion = 2, asistenciaFinal = 4 WHERE id_periodo = $id_periodo AND fechaRetiro > 0000-00-00");
