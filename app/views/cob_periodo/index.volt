...
{{ content() }}
<h1>Periodos</h1>
{{ link_to("cob_periodo/nuevo", '<i class="glyphicon glyphicon-plus"></i> Nuevo cob_periodo', "class": "btn btn-primary menu-tab") }}
...
<table class="table table-bordered table-hover">
    ...
    {% for cob_periodo in cob_periodo %}
        <tr>
        <td>{{ link_to("cob_periodo/editar/"~cob_periodo.id_periodo, '<i class="glyphicon glyphicon-pencil"></i> ', "rel": "tooltip", "title":"Editar") }}
