    ...
    <?php $fechaIngreso = $this->conversiones->fecha(2, $adicional->fechaIngreso);
    	...
    	<tr>
          ...
          <td>{{ text_field("formacionAcademica[]", "value" : adicional.formacionAcademica, "disabled" : "disabled", "placeholder" : "Formación Académica", "class" : "form-control required") }}</td>
					...
					<td>{{ text_field("porcentajeDedicacion[]", "parsley-min" : 1, "parsley-max" : 100, "value" : dedicacion, "disabled" : "disabled", "placeholder" : "Porcentaje de Dedicación", "class" : "form-control required") }}</td>
	...
	<?php for ($i = 1; $i <= 20; $i++) { ?>
        <tr style='display: none;'>
          ...
          <td>{{ select("tipoContrato[]", "disabled" : "disabled", tipoContrato, "class" : "form-control tipoContrato required") }}</td>
					...
					<td>{{ text_field("porcentajeDedicacion[]", "parsley-min" : 1, "parsley-max" : 100, "disabled" : "disabled", "placeholder" : "Porcentaje Dedicación", "class" : "form-control required") }}</td>
