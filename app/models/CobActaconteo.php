...
class CobActaconteo extends \Phalcon\Mvc\Model
{
    ...
    public function generarActasRcarga($cob_periodo, $carga, $facturacion, $recorrido_anterior) {
        ...
        CobActaConteo::crearTablaMat($tabla_mat, $config, $carga);
        
        //generar actas PP
        if($cob_periodo->tipo == 1){
        	CobActaConteo::generarActasPP($tabla_mat);
        }
    ...
    public function generarActasPP($tabla_mat){
    ...
    public function crearTablaMat($tabla_mat, $config, $carga){
