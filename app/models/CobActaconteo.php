...
class CobActaconteo extends \Phalcon\Mvc\Model
{
    ...
    public function generarActasRcarga($cob_periodo, $carga, $facturacion, $recorrido_anterior) {
        ...
        CobActaConteo::crearTablaMat($tabla_mat, $config, $carga, $db);
        
        //generar actas PP
        if($cob_periodo->tipo == 1){
        	CobActaConteo::generarActasPP($tabla_mat, $db, $timestamp);
        }
    ...
    public function generarActasPP($tabla_mat, $db, $timestamp){
    ...
    public function crearTablaMat($tabla_mat, $config, $db, $carga){
