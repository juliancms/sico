...
class CobActaverificaciondocumentacion extends \Phalcon\Mvc\Model
{
    ...
    public function generarActa($id_actaverificaciondocumentacion){
        ...
        $j = 1;
      			...
      			<div class='fila colb2 encabezadodoc'><div style='width: 20px;'>#</div><div style='width: 60px;'>4.1 DOCUMENTO</div><div style='width: 170px'>4.2 NOMBRE COMPLETO</div><div style='width: 80px'>4.3 GRUPO</div><div style='width: 50px'>4.4 TELÉFONO</div><div style='width: 40px'>4.5 Nombre y Nuip coinciden con SIBC</div><div style='width: 40px'>4.6 Teléfono coincide con SIBC</div><div style='width: 40px'>4.7 Teléfono coincide con SIBC</div><div style='width: 40px'>4.8  Certificado Sistema General Salud</div><div style='width: 40px'>4.9  Certificado Sisben</div><div style='width: 40px'>4.10 Certificado Formato Matrícula Firmada</div><div style='width: 40px'>4.11 Fecha Matrícula Diligenciada</div></div>";
      			$html .= $encabezado;
