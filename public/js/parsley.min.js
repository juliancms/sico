...
!function(d){var h=function(a){this.messages={defaultMessage:"This value seems to be invalid.",type:{email:"Este campo debe de ser un email válido.",url:"This value should be a valid url.",urlstrict:"This value should be a valid url.",number:"Este campo debe de ser un número.",digits:"This value should be digits.",dateIso:"Error: el formato de fecha debe de ser dd/mm/aaaa",alphanum:"This value should be alphanumeric.",phone:"This value should be a valid phone number."},notnull:"This value should not be null.",
notblank:"Este campo no puede dejarse en blanco.",required:"Este campo es requerido.",regexp:"This value seems to be invalid.",min:"Este valor debe de ser mayor o igual a %s.",max:"This value should be lower than or equal to %s.",range:"This value should be between %s and %s.",minlength:"This value is too short. It should have %s characters or more.",maxlength:"Este valor es muy largo. Debe de tener %s caracteres o menos.",rangelength:"This value length is invalid. It should be between %s and %s characters long.",
